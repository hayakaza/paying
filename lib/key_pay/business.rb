module KeyPay
  class Business < API
    ...
    JSON_ATTRIBUTES = {"id"=>"id", "name"=>"name", "abn"=>"abn", "legalName"=>"legal_name", "contactName"=>"contact_name", "contactEmailAddress"=>"contact_email_address", "contactPhoneNumber"=>"contact_phone_number", "externalId"=>"external_id", "standardHoursPerDay"=>"standard_hours_per_day"}
